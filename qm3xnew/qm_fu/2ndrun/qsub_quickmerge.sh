...
#$ -pe openmp 2
#$ -R Y
#$ -q bigmemory,bsg,bio,pub64,free88i,free72i,free40i,free32i

source ~/.qmbashrc

#REFERENCE
ref="chardonnay_qmqmcqmdcfu.fasta"
#Chardonnay_Falcon-unzip_Primary.fasta"
#QUERY
qry="Chardonnay_Falcon-unzip_Primary.fasta"
